        ...
        Container(
          ...
          decoration: new BoxDecoration(
            image: new DecorationImage(
              image: new AssetImage('assets/b1.gif'),
              fit: BoxFit.cover,
              ...
              child: Container(
                ...
                child: ListView(
                  children: <Widget>[
                    ...
                    ListTile(
                      leading:
                          FaIcon(FontAwesomeIcons.cloud, color: Colors.blue.shade300),
                      title: Text("Weather",
                          style: TextStyle(
                              fontFamily: 'Syne', fontWeight: FontWeight.bold)),
                      trailing: Text(
                    ...
                    ListTile(
                      leading:
                          FaIcon(FontAwesomeIcons.sun, color: Colors.yellow.shade300),
                      title: Text("Humidity",
                          style: TextStyle(
                              fontFamily: 'Syne', fontWeight: FontWeight.bold)),
                      trailing: Text(
                    ...
                    ListTile(
                      leading:
                          FaIcon(FontAwesomeIcons.wind, color: Colors.purple.shade300),
